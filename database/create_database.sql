...
CREATE TABLE MATERIAL_APOIO(
    ...
    ARQUIVO BLOB,
    CONSTRAINT FK_MAT_APOIO FOREIGN KEY (NOME) REFERENCES APRESENTACAO (MATERIAL_APOIO),
...
CREATE TABLE PREMIOS(
    COMPETIDOR NUMBER(5),
    PREMIO VARCHAR2(20),
    CONSTRAINT FK_PREMIOS_COMP FOREIGN KEY (COMPETIDOR) REFERENCES COMPETIDOR (INSCRICAO),
